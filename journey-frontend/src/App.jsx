  ...
  return (
    <div style={{ marginBottom: "1rem" }}>
      ...
      <div style={{ position: "relative" }}>
        <input
          type={inputType} value={value} onChange={onChange} placeholder={placeholder} onKeyDown={onKeyDown}
          style={{
            width: "100%", height: 44, borderRadius: 10, border: "1.5px solid #e2e8f0",
            background: "#f8fafc", padding: isPassword ? "0 42px 0 14px" : "0 14px", fontSize: "0.95rem",
